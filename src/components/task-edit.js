...
const createTaskEditTemplate = (task, options = {}) => {
  const {dueDate} = task;
  const {isDateShowing, isRepeatingTask, activeRepeatingDays, currentDescription, color, oldColor, externalData} = options;
  ...
  const repeatValue = isRepeatingTask ? `yes` : `no`;
